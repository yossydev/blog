---
title: "Next.jsでBFCacheの挙動をチェックする"
description: "このブログが公開されている頃には、ブラウザキャッシュやブラウザフォワード、BFCacheについてのことを書いていると思います。その中のBFCacheについて紹介しようとしている際に、簡単にサンプルが用意できるNext.jsを使おうとしたら、自分のイメージ通りの挙動をデフォルトではしてくれなかったのでメモがれたブログに残します。"
date: "2024/11/26"
...
このブログが公開されている頃には、ブラウザキャッシュやブラウザフォワード、BFCacheについてのことを書いていると思います。
その中のBFCacheについて紹介しようとしている際に、簡単にサンプルが用意できるNext.jsを使おうとしたら、自分のイメージ通りの挙動をデフォルトではしてくれなかったのでメモがれたブログに残します。
